...
function Manage(props) {
  ...
  // console.log(JSON.parse(getStore("user")).id);
      ...
      <Layout style={{ minHeight: "100vh" }}>
        <Sider collapsible collapsed={collapsed} onCollapse={onCollapse}>
          <Menu theme="dark" defaultSelectedKeys={["1"]} mode="inline">
            ...
            <SubMenu key="sub1" title="数据管理">
              ...
              <Menu.Item key="6">
                <Link to="/manage/oderlist">订单列表</Link>
              </Menu.Item>
              <Menu.Item key="7">
            ...
            <SubMenu key="sub4" title="编辑">
              <Menu.Item key="11">
                <Link to="/manage/ediet">文本编辑</Link>
              </Menu.Item>
            </SubMenu>
        ...
        <Layout className="site-layout">
          ...
          <Content style={{ margin: "0 16px" }} key={props.location.key}>
            ...
            <Route
                exact  path="/manage"
                  render={() => <Redirect to="/manage/home" />}
                />

            <Route path="/manage/home" component={Home} />
            <Route
              path="/manage/addgoods/:restaurant_id?"
              component={AddGoods}
            />
            ...
            <Route path="/manage/foodlist" component={FoodList} />
            <Route path="/manage/oderlist" component={OderList} />
            <Route path="/manage/shoplist" component={ShopList} />
            <Route path="/manage/ediet" component={Ediet} />
            <Route path="/manage/visitor" component={Visitor} />
